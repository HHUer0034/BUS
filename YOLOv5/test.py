...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'E:\Anaconda3\envs\y5\yolov5-5.0\runs\train\yolov5s+原数据集100\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='bus.yaml', help='*.data path')
